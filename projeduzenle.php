						...
						<form action="islemler/islem.php" method="POST" enctype="multipart/form-data"  data-parsley-validate>
							...
							<div class="form-row">
								<div class="form-group col-md-12">
									<textarea class="textarea-container" name="proje_detay" id="editor"><?php echo $projenindetaymetni; ?></textarea>
								</div>
							</div>
							<input type="hidden" class="form-control" name="proje_id" value="<?php echo $_POST['proje_id'] ?>">
							<button style="width: 200px;" type="submit" name="projeguncelle" class="btn btn-success">Kaydet</button>
						</form>
					</div>
				</div>
			</div>
