...
<style>
    ...
    margin: 0 auto; /* Soldan ve sağdan eşit miktarda boşluk */
}
</style>
					...
					<form action="islemler/islem.php" method="POST">
						...
						<div class="form-row">
							...
							<div disabled class="form-group col-md-6">
								...
								<input disabled type="text" class="form-control" value="Yeni">
							</div>
							<?php $durum=$projecek['proje_durum']; ?>
							<div disabled class="form-group col-md-6">
								<label>Proje Durumu</label>
								<input disabled type="text" class="form-control" value="Normal">
							</div>
						</div>	
						<div class="form-row">
							<div class="form-group col-md-6">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								<textarea disabled class="textarea-container" id="editor"><?php echo $projenindetaymetni; ?></textarea>
							</div>
						</div>
